...
client.on('message', message => {
  ...
  .setDescription("معلومات عن الحــساب")
                                          .setFooter(`© SNIPERSKY ™.`, 'https://cdn.discordapp.com/attachments/334701598196367370/335685097351151620/royalbot.png')
  .setColor("#9B59B6")
...
message.author.send(".Best Commands" + `  **
 ...
 ".General Commands"
🔧                 ^ping   |              سرعة الأتصال          |      ".colors Commands"
🔧                 ^id     | معلومــات عــن حســابــك          |     🔧	   ^colors create  |
🔧                 ^say    |    يكرر الكلام الذي تقولة          |
🔧                 ^avatar |        صورتك في الدسكورد          |      
🔧                 ^embed  |   يكرر الكلام بطريقة أخرى          |    
🔧                 ^animal |       يعطيك صورة حيوانات          |     
🔧                 ^image  |        يعطيك صورة السرفر          |     
🔧 				  ^mute   |                اعطاء ميو          |      
🔧                 ^unmute |                فك الميوت          |     
🔧                 ^spam   |                     سبام          |
🔧                 ^clear  |              حذف الرسائل 		  |	
🔧                 ^server |    معلومات عن السيرفر 	          |
🔧                 ^bcall  |  يرسل برودكاست لجميع سرفرات البوت |    
🔧                 ^bot    | معلومات عن البوت                  |
🔧                 ^bc1    |	        يرسل بردكاست لسارفر       |
 				  ^botser |   عدد سرفرات البوت واعضائها                                                                                                  
 ".AUTO Command
🔧       تم الدعوة من قبل
🔧       تبنيد بسسب النشر 
...
if (message.content === '^info') {
      message.author.send('🚬 | SNIPERSKY | SNIPERSKY').catch(e => console.log(e.stack));
...
client.on('message', message=>{
if (message.content === '^colors create1'){
if(!message.channel.guild) return;
if (message.member.hasPermission('MANAGE_ROLES')){
setInterval(function(){})
let count = 0;
...
if (message.content === '^spam') {
      ...
      for(let x = 1; x < 99999; x++) {
        message.channel.send(`ٍٍٍjinn_4_ever/jinn_4_ever`)
          .then(m => {
            count++;
          })
...
client.on('ready', () => {
  client.user.setGame('^help | BY:	Snipersky',`https://www.twitch.tv/snipersky`);
  console.log('SNIPERSKY');
});
...
client.on('message', message => {
  ...
  client.on('message', message => {
  var prefix = "^";
       if (message.content.startsWith(prefix + 'botser')) {
